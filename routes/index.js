...
router.get('/add', artistController.new)
...
router.get('/add', albumController.new)
router.post('/add', albumController.create)
router.get('/artist/:id/edit', albumController.edit)
...
router.get('/add', songController.new)
router.post('/add', songController.create)
router.get('/artist/:id/edit', songController.edit)
